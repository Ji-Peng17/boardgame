        ...
        <div class="row p-3">
            ...
            <div class="col-8 row" style="color: gray;">
                <div class="col-md-5 col-12">
                    <img src="../_image/c1.jpg" alt="" class="w-100">
                </div>
                <div class="col-md-7 col-12">
                    <div>
                        <div style="font-size: 40px; color: black;">璀璨寶石 Splendor</div>
                        <div style="font-size: 30px; color: rgb(0, 51, 255) ;">NT$ 1,400</div>
                    </div>
                    <hr>
                    <div>輸入購買數量:
                    ...
                    <hr>
                    <div>
                        榮獲 2014 年度最佳遊戲 2014 Golden Geek Board Game of the Year。 獲得 2014 Spiel des
                        Jahres Nominee 德國桌遊年度大獎提名殊榮。
                        <br><br>
                        擁有優雅華麗的美術風格，引領玩家進入文藝復興的歐洲地區，擁有最多的寶石將會吸引貴族前往投資。利用手上的資源獲取礦脈、運輸方式以及工匠，工匠將會把你手上的原石冶煉成完美無瑕的寶石！
                    </div>
                </div>
    ...
    <script>
        ...
        function cal() {
            ...
            if (notAgain < 1) {
                ...
                document.cookie = `c1qtt = ${num.value}`;
