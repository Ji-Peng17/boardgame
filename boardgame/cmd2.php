        ...
        <div class="row text-decoration-none pt-4" style="font-size: 20px;">
            ...
            <div class="col-8 row m-0">
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer1.php">
                        <img src="../_image/mer1.jpg" class="w-100">
                        <div class="m-1">藍色套骰</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer2.php">
                        <img src="../_image/mer2.jpg" class="w-100">
                        <div class="m-1">紫色套骰</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer3.php">
                        <img src="../_image/mer3.jpg" class="w-100">
                        <div class="m-1">黑色套骰</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer4.php">
                        <img src="../_image/mer4.jpg" class="w-100">
                        <div class="m-1">橘色套骰</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer5.php">
                        <img src="../_image/mer5.jpg" class="w-100">
                        <div class="m-1">綠色套骰</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer6.php">
                        <img src="../_image/mer6.jpg" class="w-100">
                        <div class="m-1">木質骰塔</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer7.php">
                        <img src="../_image/mer7.jpg" class="w-100">
                        <div class="m-1">透明卡盒</div>
                    </a>
                </div>
                <div class="col-sm-6 col-lg-3 py-3 cmd pm1">
                    <a href="mer8.php">
                        <img src="../_image/mer8.jpg" class="w-100">
                        <div class="m-1">透明收納盒</div>
                    </a>
                </div>
                </a>
            </div>
