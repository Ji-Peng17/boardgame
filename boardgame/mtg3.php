        ...
        <div class="row p-3">
            ...
            <div class="col-8 row" style="color: gray;">
                <div class="col-md-5 col-12">
                    <img src="../_image/pm1.jpg" alt="" class="w-100">
                </div>
                <div class="col-md-7 col-12">
                    <div>
                        <div style="font-size: 40px; color: black;">近代新篇2 補充盒</div>
                        <div style="font-size: 30px; color: rgb(0, 51, 255) ;">NT$ 12,000</div>
                    </div>
                    <hr>
                    <div>輸入購買數量:
                    ...
                    <div>
                        1 盒含 36 包補充包。
                        <br>
                        每包補充包有15張牌（1張稀有/秘稀牌、3張非普通牌、10張普通牌、1張基本地）。
                    </div>
                    <div class="text-end m-2 fs-6">
                        <a href="pm.php"> 回上一頁</a>
                    </div>
                </div>
                <div class="col-2"></div>
            </div>
        ...
        <script>
            ...
            function cal() {
                ...
                if (notAgain < 1) {
                    ...
                    document.cookie = `c6qtt = ${num.value}`;
