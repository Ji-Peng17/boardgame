        ...
        <div class="row p-3">
            ...
            <div class="col-8 row" style="color: gray;">
                <div class="col-md-5 col-12">
                    <img src="../_image/c2.jpg" alt="" class="w-100">
                </div>
                <div class="col-md-7 col-12">
                    <div>
                        <div style="font-size: 40px; color: black;">圖騰快手<br> JUNGLE SPEED</div>
                        <div style="font-size: 30px; color: rgb(0, 51, 255) ;">NT$ 790</div>
                    </div>
                    <hr>
                    <div>輸入購買數量:
                    ...
                    <div class="text-primary">
                        作者｜Thomas Vuarchex & Pierric Yakovenko
                        <br>
                        7+歲｜2-10人｜15分鐘
                    </div>
                    <hr>
                    <div>
                        考驗你的觀察力及反應速度。
                        <br><br>
                        當你和其他玩家的牌出現一樣的圖案時，趕快抓取桌面中央的圖騰，以便將牌送給反應較慢的玩家。困難的是，有些圖案幾乎一樣，而且，時常出現特殊牌，改變遊戲的規則，這讓玩家十分容易出錯而被罰拿到更多的牌！
                        <br><br>
                        你能夠維持專注力搶先將自己的牌出清而成為贏家嗎？
                    </div>
