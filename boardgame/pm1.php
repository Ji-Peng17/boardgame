        ...
        <div class="row p-3">
            ...
            <div class="col-8 row" style="color: gray;">
                ...
                <div class="col-md-7 col-12">
                    <div>
                        <div style="font-size: 40px; color: black;">寶可夢 朱 & 紫 紫ex</div>
                        <div style="font-size: 30px; color: rgb(0, 51, 255) ;">NT$ 1,470</div>
                    </div>
                    <hr>
                    <div>輸入購買數量:
        ...
        <script>
            ...
            function cal() {
                ...
                if (notAgain < 1) {
                    ...
                    document.cookie = `c5qtt = ${num.value}`;
